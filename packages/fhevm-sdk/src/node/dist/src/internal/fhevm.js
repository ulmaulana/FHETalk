...
export const createFhevmInstance = async (parameters) => {
    ...
    const { signal, onStatusChange, provider: providerOrUrl, mockChains, chainId: providedChainId, } = parameters;
    // Resolve chainId
    ...
    throwIfAborted();
    // Check for both uppercase and lowercase versions
    let relayerSDK = window.RelayerSDK || window.relayerSDK;
    if (!relayerSDK) {
        notify("sdk-loading");
        ...
        relayerSDK = window.RelayerSDK || window.relayerSDK;
        if (!relayerSDK) {
