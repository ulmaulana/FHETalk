...
export const getEncryptionMethod = (internalType) => {
    if (internalType.includes("uint8"))
        return "encrypt8";
    if (internalType.includes("uint16"))
        return "encrypt16";
    if (internalType.includes("uint32"))
        return "encrypt32";
    if (internalType.includes("uint64"))
        return "encrypt64";
    if (internalType.includes("uint128"))
        return "encrypt128";
    if (internalType.includes("uint256"))
        return "encrypt256";
    if (internalType.includes("bool"))
        return "encrypt_bool";
